...
class BigBorderedButton extends StatelessWidget {
  ...
  const BigBorderedButton({Key? key, this.onTap, required this.text, this.buttonColor, this.textColor, this.textStyle, this.horizontal, this.vertical, this.borderRadius}) : super(key: key);
    ...
    return Padding(
      ...
      child: GestureDetector(
        ...
        child: Container(
          ...
          child: Center(child: Text(text, textAlign: TextAlign.center, style: textStyle ?? MainStyles.boldTextStyle.copyWith(color: textColor ?? MainColors.generalColor!),)),
        ),
      ),
    );
  }
